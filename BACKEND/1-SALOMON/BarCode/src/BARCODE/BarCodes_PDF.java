...
public class BarCodes_PDF {
	public static void main(String[] args) {
		BarCodes_PDF.createPDF("chillyfacts.pdf","Mbengono");
	}
	...
	public static void createPDF(String pdfFilename,String myString) {
	    ...
	    try {
	        docWriter = PdfWriter.getInstance(doc, new FileOutputStream("C:\\Users\\Friends\\Desktop\\MY_Barcode\\"+pdfFilename));
	        doc.addAuthor("Mbengono");
	        doc.addCreationDate();
	        doc.addProducer();
